...
<div style="text-align: center;">
    <img src="https://assets.ccbp.in/frontend/content/react-js/browser-history-output.gif" alt="browser history output" style="max-width:70%;box-shadow:0 2.8px 2.2px reba(0, 0, 0, 0.12)">
</div>
<br/>
...
- The delete button in the history item should have the `data-testis` as **delete**
